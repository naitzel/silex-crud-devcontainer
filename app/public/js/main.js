...
var ckeditor_config = {
    language: 'pt-br', // Linguagem do editor
    uiColor: '#ECF0F5', // Cor do editor
    scayt_autoStartup: true, // Habilitar corretor ortográfico
    scayt_sLang: 'pt_BR', // corretor ortográfico português
    toolbarGroups: [{
        name: 'clipboard',
...
jQuery(function() {
    jQuery('.content-wrapper').css({
        'min-height': jQuery('.main-sidebar').height()
    });
